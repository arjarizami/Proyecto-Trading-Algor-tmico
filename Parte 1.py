...
def make_pipeline():
    ...
    debt = Fundamentals.capital_expenditure.latest
    ...
    cash_winsorized = cash.winsorize(min_percentile=0.05, max_percentile=0.95)
    debt_winsorized = debt.winsorize(min_percentile=0.05, max_percentile=0.95)
    ...
    combined_factor = (
        ...
        assets_winsorized.zscore()*0.1 +
        cash_winsorized.zscore()*0.2 +
        debt_winsorized.zscore()*0.2
    )
